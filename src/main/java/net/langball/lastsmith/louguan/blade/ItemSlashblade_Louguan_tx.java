...
public class ItemSlashblade_Louguan_tx {
	   ...
	   public void init(InitEvent event) {
	      ...
	      SlashBlade.addRecipe(nametx, new RecipeAwakeBladeTLS(new ResourceLocation(SlashBlade.modid,nametx),louguan, custombladeReqired, new Object[]{"DAD", "CBC", "DCD", Character.valueOf('A'),"sphereSakura",Character.valueOf('B'), custombladeReqired, Character.valueOf('C'), itemSphereBladeSoul, Character.valueOf('D'), new ItemStack(Blocks.DIAMOND_BLOCK)}));
	   }
