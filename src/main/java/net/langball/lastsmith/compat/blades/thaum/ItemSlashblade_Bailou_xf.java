...
public class ItemSlashblade_Bailou_xf {
	   ...
	   public void init(InitEvent event) {
	      ...
	      ItemSlashBlade.RepairCount.set(reqTag, Integer.valueOf(5));
			...
			ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Last_worker.MODID,name), new InfusionRecipeAwakeBlade("HAKUROUSENPUUZIN", BladeLoader.findItemStack(Last_worker.MODID,name,1), 1, new AspectList()
