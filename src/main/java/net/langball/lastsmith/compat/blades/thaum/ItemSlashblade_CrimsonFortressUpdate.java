...
public class ItemSlashblade_CrimsonFortressUpdate {
	   @SubscribeEvent
	   public void init(InitEvent event) {
		   
	      String name = "flammpfeil.slashblade.named.fortress.crimson.update";
	      ...
	      ItemSlashBlade.TextureName.set(tag, "named/thaum/ModelKatanaCrimsonUpdate");
	      ...
	      ItemSlashBladeNamedSS.NamedBlades.add(name);
			ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Last_worker.MODID,name), new InfusionRecipeAwakeBlade("BLADEUPDATE", BladeLoader.findItemStack(Last_worker.MODID,name,1), 1, new AspectList()
		    	      .add(Aspect.ENERGY, 75).add(Aspect.SOUL, 75).add(Aspect.AVERSION,75),BladeLoader.getCustomBlade("flammpfeil.slashblade.named.fortress.crimson"), 
		    	      new Object[] {
		    	    		   "obsidian"
