...
public class ItemSlashblade_VoidFortressUpdate {
	   @SubscribeEvent
	   public void init(InitEvent event) {
		   
	      String name = "flammpfeil.slashblade.named.fortress.void.update";
	      ItemStack customblade = new ItemStack(BladeLoader.voidBlade, 1, 0);
	      NBTTagCompound tag = new NBTTagCompound();
	      customblade.setTagCompound(tag);
	      ItemSlashBladeNamedSS.CurrentItemName.set(tag, name);
	      ItemSlashBladeNamedSS.CustomMaxDamage.set(tag, Integer.valueOf(50));
	      ItemSlashBlade.setBaseAttackModifier(tag, 7.0F + ThaumcraftMaterials.TOOLMAT_VOID.getAttackDamage());
	      ItemSlashBladeNamedSS.IsDefaultBewitched.set(tag, Boolean.valueOf(true));
	      ItemSlashBlade.TextureName.set(tag, "named/thaum/ModelKatanaVoidmetalUpdate");
	      ...
	      ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Last_worker.MODID,name), new InfusionRecipeAwakeBlade("BLADEUPDATE", BladeLoader.findItemStack(Last_worker.MODID,name,1), 1, new AspectList()
		    	      .add(Aspect.ENERGY, 75).add(Aspect.SOUL, 75).add(Aspect.AVERSION,75),BladeLoader.getCustomBlade("flammpfeil.slashblade.named.fortress.void"), 
		    	      new Object[] {
		    	    		   "obsidian"
