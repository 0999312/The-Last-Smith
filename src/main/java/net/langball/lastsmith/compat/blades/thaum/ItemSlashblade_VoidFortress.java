...
public class ItemSlashblade_VoidFortress {
	   @SubscribeEvent
	   public void init(InitEvent event) {
		   
	      String name = "flammpfeil.slashblade.named.fortress.void";
	      ...
	      ItemSlashBlade.setBaseAttackModifier(tag, 5.0F + ThaumcraftMaterials.TOOLMAT_VOID.getAttackDamage());
	      ItemSlashBladeNamedSS.IsFakeBlade.set(tag, true);
	      ItemSlashBlade.TextureName.set(tag, "named/thaum/ModelKatanaVoidmetal");
	      ...
	      ItemSlashBladeNamedSS.NamedBlades.add(name);
			ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(Last_worker.MODID,name), new InfusionRecipe("THAUMBLADE", BladeLoader.findItemStack(Last_worker.MODID,name,1), 1, new AspectList()
		    	      .add(Aspect.ENERGY, 50).add(Aspect.SOUL, 50).add(Aspect.AVERSION,50),ItemsTC.voidSword, 
		    	      new Object[] {
		    	    		   "obsidian"
		    	    		 , "ingotVoid"
		    	    		 , "ingotGold"
