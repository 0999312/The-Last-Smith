...
public class ItemSlashblade_2 {
	   ...
	   public void init(InitEvent event) {
	      ...
	      ItemSlashBladeNamedSS.CustomMaxDamage.set(tag, Integer.valueOf(100));
	      ...
	      ItemSlashBlade.ProudSoul.set(reqTag, Integer.valueOf(2500));
	      ...
	      SlashBlade.addRecipe(name, new RecipeAwakeBlade(new ResourceLocation(SlashBlade.modid,name), louguan, custombladeReqired, new Object[]{"IAI", "ABA", "IAI", Character.valueOf('I'),IC2Items.getItem("crafting", "iridium"), Character.valueOf('B'), custombladeReqired,Character.valueOf('A'),IC2Items.getItem("crafting", "alloy")}));
	   }
