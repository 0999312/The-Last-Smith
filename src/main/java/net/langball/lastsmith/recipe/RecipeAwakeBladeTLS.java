...
public class RecipeAwakeBladeTLS extends RecipeAwakeBlade {
    ItemStack requiredStateBlade = ItemStack.EMPTY;
    
	public RecipeAwakeBladeTLS(ResourceLocation loc, ItemStack result, ItemStack requiredStateBlade, Object[] recipe) {
