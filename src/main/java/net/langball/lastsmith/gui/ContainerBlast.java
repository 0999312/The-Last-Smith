...
import net.langball.lastsmith.blocks.TileEntityBlast;
...
public class ContainerBlast extends Container
{
    ...
    public ContainerBlast(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 17));
        this.addSlotToContainer(new SlotFurnaceFuel(furnaceInventory, 1, 56, 53));
        this.addSlotToContainer(new SlotBlastOutput(playerInventory.player, furnaceInventory, 2, 116, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (!BlastRecipes.instance().getSmeltingResult(itemstack1).isEmpty())
                {
