...
public class ItemSlashblade_Blade_bamboo_fake {
	   @SubscribeEvent
	   public void init(InitEvent event) {
		  String name = "wrap.BambooMod.katana_fake";
	      String name2 = "flammpfeil.slashblade.named.namedblade_basic";
	      ...
	      SlashBlade.addRecipe(name, new RecipeAwakeBlade(new ResourceLocation(SlashBlade.modid,name),customblade, custombladeReqired, new Object[]{" DA", "DAC", "BCH",Character.valueOf('H'), ItemLoader.hammer, Character.valueOf('A'),ingot, Character.valueOf('B'), custombladeReqired, Character.valueOf('C'), "dyeRed", Character.valueOf('D'), new ItemStack(ItemLoader.material,1,7)}));
