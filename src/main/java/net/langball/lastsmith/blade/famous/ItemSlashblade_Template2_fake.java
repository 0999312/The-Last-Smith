...
public class ItemSlashblade_Template2_fake {
	@SubscribeEvent
	   public void init(InitEvent event) {
	      String name = "flammpfeil.slashblade.named.template_re2_fake";
	      String name2 = "flammpfeil.slashblade.named.namedblade_basic";
	      ItemStack customblade = new ItemStack(BladeLoader.bladeNamed, 1, 0);
	      NBTTagCompound tag = new NBTTagCompound();
	      customblade.setTagCompound(tag);
	      ItemSlashBladeNamedSS.CurrentItemName.set(tag, name);
	      ItemSlashBladeNamedSS.CustomMaxDamage.set(tag, Integer.valueOf(65));
	      ...
	      ItemSlashBlade.TextureName.set(tag, "named/famous/6");
