...
public class ItemSlashblade_943 {
	   @SubscribeEvent
	   public void init(InitEvent event) {
	      String name = "flammpfeil.slashblade.named.acid";
	      ...
	      ItemSlashBlade.TextureName.set(tag, "named/Arthurs/texture_943");
