...
public class ItemSlashblade_xiaomo {
	   @SubscribeEvent
	   public void init(InitEvent event) {
	      String name = "flammpfeil.slashblade.named.xiaomo";
	      ...
	      ItemSlashBlade.TextureName.set(tag, "named/Arthurs/texture_xiaomo");
