...
public class ItemSlashblade_luli {
	   @SubscribeEvent
	   public void init(InitEvent event) {
	      String name = "flammpfeil.slashblade.named.luli";
	      ...
	      ItemSlashBlade.TextureName.set(tag, "named/Arthurs/texture_luli");
	      ItemSlashBlade.ModelName.set(tag, "named/Arthurs/model_luli");
