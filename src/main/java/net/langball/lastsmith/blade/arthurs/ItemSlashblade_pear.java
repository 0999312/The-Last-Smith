...
public class ItemSlashblade_pear {
	   @SubscribeEvent
	   public void init(InitEvent event) {
	      String name = "flammpfeil.slashblade.named.pear";
	      ...
	      ItemSlashBlade.TextureName.set(tag, "named/Arthurs/texture_pear");
	      ItemSlashBlade.ModelName.set(tag, "named/Arthurs/model_pear");
