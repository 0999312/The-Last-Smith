...
public class ItemSlashblade_zheng {
	   @SubscribeEvent
	   public void init(InitEvent event) {
	      String name = "flammpfeil.slashblade.named.zheng";
