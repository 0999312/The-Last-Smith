...
public class ItemSlashblade_sagequoia {
	   @SubscribeEvent
	   public void init(InitEvent event) {
	      String name = "flammpfeil.slashblade.named.sagequoia";
