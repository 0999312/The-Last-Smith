...
public class ItemSlashblade_sakuya {
	   ...
	   public void init(InitEvent event) {
	      ...
	      ItemSlashBlade.TextureName.set(tag, "named/sakura/texture");
	      ...
	      SlashBlade.addRecipe(name, new RecipeAwakeBladeTLS(new ResourceLocation(SlashBlade.modid,name),louguan, custombladeReqired, new Object[]{"DAD", "FBF", "DAD", Character.valueOf('A'), itemSphereBladeSoul, Character.valueOf('B'), custombladeReqired, Character.valueOf('D'), new ItemStack(ItemLoader.material,1,7),'F',"dyeRed"}));
	   }
