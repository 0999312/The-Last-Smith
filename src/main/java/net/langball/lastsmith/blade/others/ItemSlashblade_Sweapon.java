...
public class ItemSlashblade_Sweapon {
	   ...
	   public void init(InitEvent event) {
	      ...
	      SlashBlade.addRecipe(name, new RecipeAwakeBlade(new ResourceLocation(SlashBlade.modid,name),louguan, custombladeReqired, new Object[]{" AD", " AD", " B ", Character.valueOf('A'), Items.IRON_INGOT, Character.valueOf('B'), custombladeReqired, Character.valueOf('D'), new ItemStack(Blocks.LAPIS_BLOCK)}));
	   }
