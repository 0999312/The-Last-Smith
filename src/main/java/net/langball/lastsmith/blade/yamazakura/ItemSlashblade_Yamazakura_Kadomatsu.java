...
public class ItemSlashblade_Yamazakura_Kadomatsu {
	@SubscribeEvent
	   public void init(InitEvent event) {
		  String name = "flammpfeil.slashblade.named.yamazakura.kadomatsu";
	      ...
	      DropEventHandler.registerEntityDrop(new ResourceLocation("minecraft","vex"), 0.01f, BladeLoader.findItemStack(Last_worker.MODID, name, 1));
