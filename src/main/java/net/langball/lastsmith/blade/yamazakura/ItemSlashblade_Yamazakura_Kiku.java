...
public class ItemSlashblade_Yamazakura_Kiku {
	@SubscribeEvent
	   public void init(InitEvent event) {
		  String name = "flammpfeil.slashblade.named.yamazakura.kiku";
	      ...
	      ItemSlashBlade.TextureName.set(tag, "named/yamazakura/yamazakura_nagatsuki_kiku");
	      ...
	      DropEventHandler.registerEntityDrop(new ResourceLocation("minecraft","skeleton"),-0.06f, BladeLoader.findItemStack(Last_worker.MODID, name, 1));
